#!/usr/bin/python
# Obtained from: https://gist.github.com/shreyansb/1622514
...
def mail(gmail_user, gmail_pwd, from_gmail_user, to, subject, text, cc=None, bcc=None, reply_to=None, attach=None,
